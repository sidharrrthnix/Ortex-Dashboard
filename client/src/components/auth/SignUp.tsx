...
//For Simplicity you can login with your username and password for the first time
// the app will sign you in i.e(you can use any username and password).
// Please remeber your credentials. as it will help you to Sign back in
const SignUp: React.FC = () => {
  ...
  //On form submit the Sign Up component will log you inside the app
  // signUp is the action creator responsible for signing up
  ...
  return (
    <div className="relative  overflow-hidden">
      ...
      >
        ...
        <main className="mt-16 relative sm:mt-24">
                    ...
                    <div className="mt-6">
                      ...
                      >
                        ...
                        <div>
                          <button
                            type="submit"
                            className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-theme hover:bg-lighttheme focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme"
                          >
